          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-center md:text-left">
              ...
              <p className="text-slate-400 text-xs mt-1">
                © 2026 shibuiwilliam. Licensed under MIT License.
              </p>
            </div>
            <div className="flex items-center gap-6">
              <button
                onClick={() => setIsTermsOpen(true)}
                className="text-slate-300 hover:text-white text-sm transition-colors underline"
              >
                {t.footer.termsOfUse}
              </button>
              <a
                href="https://github.com/shibuiwilliam/ai-agent-readiness-check"
                target="_blank"
